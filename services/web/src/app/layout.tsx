      ...
      <body className="min-h-dvh antialiased">
        ...
        <div className="flex min-h-dvh flex-col">
          <header className="border-b border-[var(--color-rule)] bg-[var(--color-surface)]">
            <div className="mx-auto flex max-w-5xl flex-wrap items-baseline gap-x-5 gap-y-2 px-6 py-5">
              <Link
                href="/"
              ...
              <span className="font-[family-name:var(--font-mono)] text-[0.68rem] uppercase tracking-[0.14em] text-[var(--color-muted)]">
