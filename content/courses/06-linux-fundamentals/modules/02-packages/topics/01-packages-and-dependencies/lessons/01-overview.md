...
:::predict{question="On the machine you are about to work on, 19 packages were named in the Dockerfile. How many packages do you think are actually installed?"}
:::
...
This container's Dockerfile names nineteen packages, eighteen of which the
...
Eighteen are recorded as requested. **One hundred and fifty-seven arrived as a
...
a container image is 180 MB when you installed four things, the gap between 18
and 175 is the entire answer.
...
- Trace 18 requested packages into 175 installed ones, and find the dependency
  that was skipped.
